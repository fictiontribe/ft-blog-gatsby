...
},{"./gsap-core.js":"TNS6","./CSSPlugin.js":"bp4Z"}],"VJtr":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = displayEndscreen;

var _gsap = require("gsap");

function displayEndscreen(story) {
  document.querySelector(".end-screen-wrapper").classList.remove("hidden");
  document.querySelector(".story").innerHTML = story;
  document.body.style.overflow = 'hidden';

  function storyReveal() {
    document.querySelector(".story").classList.add("reveal"); // document.body.style.overflow = 'visible';
  ...
  typewriter.typeString("Congratulations!<br>").pauseFor(1000) // .deleteAll()
  .typeString("You have unlocked your personal story!").pauseFor(1000).callFunction(function () {
    storyReveal();
    fireConfetti();
  }).start();
  var count = 400;
...
document.querySelector('.fiction-boy_dpad-up').addEventListener('mousedown', function () {
  document.querySelector('.fiction-boy').classList.add('dpad-up');
...
document.querySelector('.fiction-boy_dpad-down').addEventListener('mousedown', function () {
  document.querySelector('.fiction-boy').classList.add('dpad-down');
  window.dispatchEvent(new KeyboardEvent('keydown', {
    'keyCode': 40
  }));
});
...
document.querySelector('.fiction-boy_dpad-left').addEventListener('mousedown', function () {
  document.querySelector('.fiction-boy').classList.add('dpad-left');
  window.dispatchEvent(new KeyboardEvent('keydown', {
    'keyCode': 37
  }));
});
...
document.querySelector('.fiction-boy_dpad-right').addEventListener('mousedown', function () {
  document.querySelector('.fiction-boy').classList.add('dpad-right');
  window.dispatchEvent(new KeyboardEvent('keydown', {
    'keyCode': 39
  }));
});
...
document.querySelector('.fiction-boy_a-btn').addEventListener('click', function () {
  document.querySelector('.fiction-boy').classList.add('a-down');
  setTimeout(function () {
    document.querySelector('.fiction-boy').classList.remove('a-down');
  }, 100);
});
document.querySelector('.fiction-boy_b-btn').addEventListener('click', function () {
  document.querySelector('.fiction-boy').classList.add('b-down');
  setTimeout(function () {
    document.querySelector('.fiction-boy').classList.remove('b-down');
  }, 100);
});
document.querySelector('.fiction-boy_start-btn').addEventListener('click', function () {
  document.querySelector('.fiction-boy').classList.add('start-down');
  setTimeout(function () {
    document.querySelector('.fiction-boy').classList.remove('start-down');
  }, 100);
}); // Modal / Open button
